...
<%%>
<div class="databox" style="width: 1000px; margin-left: 220px; padding: 50px;">
	<form name="password1" class="password-form"
			action="password.check.jsp" method="post">
	<div class="fixbanner" style="border-bottom: 2px solid #ff80c0; width: 400px; margin-bottom: 20px;">
		<span style="font-size: 25px;">비밀번호 확인</span>
	</div>
	<table class="logindata">
		<tr>
			<th>비밀번호</th>
			<td><input type="password" name="m_pwd" autofocus></td>
		</tr>
	</table>
	<div id="send_btn">
		<input type="submit" value="정보 수정하기" class="pink_btn" id="password-btn">
